...
import artraction.Artraction;
import artraction.mysqlconnect;
import artraction.users;
import java.net.URL;
...
public class FXMLDocumentController implements Initializable {
  ...
  @FXML
    ...
    @FXML
    private TextField txt_adresse_up3;

    @FXML
    private TextField txt_numero_telephone_up3;
  ...
  @FXML
    public void add_users(ActionEvent event){    
        ...
        try {
            ...
            pst.setString(2,email_up .getText());
            pst.setString(3,txt_password_up.getText());
            pst.setString(4,date .getValue().toString());
            pst.setString(5,txt_numero_telephone_up3.getText());
            pst.setString(6,txt_adresse_up3 .getText());
