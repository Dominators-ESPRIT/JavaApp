...
public class Competition {
    ...
    public Competition(int ref_competition, String nom, String theme, String date_debut, String date_fin, String type) {
    ...
    public Competition(String nom, String date_debut, String date_fin, String type) {
        this.nom = nom;
        this.date_debut = date_debut;
        this.date_fin = date_fin;
        this.type = type;
    ...
    public Competition(String nom, String theme, String date_debut, String date_fin, String type) {
        this.nom = nom;
        this.theme = theme;
        this.date_debut = date_debut;
        this.date_fin = date_fin;
